import e from"node:fs";import{isMap as t,isSeq as r,isScalar as s,parseDocument as n,Scalar as o,isPair as i,YAMLMap as a,YAMLError as c}from"yaml";import{resolve as l,join as u,basename as d}from"node:path";import p from"picocolors";import f from"node:net";import{createHash as m}from"node:crypto";const h="LINTER";class y{static instance;debugMode=!1;constructor(e){void 0!==e&&(this.debugMode=e)}static init(e){y.instance||(y.instance=new y(e))}static getInstance(){if(!y.instance)throw new Error("Logger is not initialized. Call Logger.init() first.");return y.instance}static formatMessage(e,t){const r=y.getColoredLevel(e);return t?`${r} [${t}]`:r}static getColoredLevel(e){switch(e){case"DEBUG":return p.blue("[DEBUG]");case"INFO":return p.green("[INFO]");case"WARN":return p.yellow("[WARN]");case"ERROR":return p.red("[ERROR]");default:return`[${e}]`}}debug(e,...t){if(this.debugMode){const r=y.formatMessage("DEBUG",e);console.debug(r,...t)}}info(...e){const t=y.formatMessage("INFO");console.info(t,...e)}warn(...e){const t=y.formatMessage("WARN");console.warn(t,...e)}error(...e){const t=y.formatMessage("ERROR");console.error(t,...e)}}class g extends Error{constructor(e){super(),this.message=`File or directory not found: ${e}`,this.name="FileNotFoundError"}}function v(t,r,s){const n=y.getInstance();n.debug("UTIL",`Looking for compose files in ${t.toString()}`);let o=[];const i=new Set(["node_modules",".git",".idea",".tsimp"]);s&&s.length>0&&s.forEach((e=>i.add(e)));const a=[...i];n.debug("UTIL",`Paths to exclude: ${a.toString()}`);const c=/^(docker-)?compose.*\.ya?ml$/;return t.forEach((t=>{if(!e.existsSync(t))throw n.debug("UTIL",`File or directory not found: ${t}`),new g(t);let s=[];const i=e.statSync(t);if(i.isDirectory()){try{s=e.readdirSync(l(t)).map((e=>u(t,e)))}catch(e){n.debug("UTIL",`Error reading directory: ${t}`,e),s=[]}s.forEach((t=>{if(a.some((e=>t.includes(e))))return void n.debug("UTIL",`Excluding ${t}`);const s=e.statSync(l(t));if(s.isDirectory()){if(r){n.debug("UTIL",`Recursive search is enabled, search within the directory: ${t}`);const e=v([t],r,a);o=[...o,...e]}}else s.isFile()&&c.test(d(t))&&o.push(t)}))}else i.isFile()&&o.push(t)})),n.debug("UTIL",`Found compose files in ${t.toString()}: ${o.length>0?o.join(", "):"None"}`),o}function $(e,t){const r=e.split("\n"),s=new RegExp(`^\\s*${t}:`,"i");let n=1;for(const e of r){if(s.test(e))return n;n+=1}return 1}function b(e,t){const r=e.split("\n").findIndex((e=>e.includes(t)));return-1===r?1:r+1}function _(e,n,o,i,a){const c=e.get("services");if(!t(c))return 1;const l=c.get(o);if(!t(l))return 1;if(!i)return function(e,t){if(e.range){const[r]=e.range;return t.slice(0,r).split("\n").length-1}return 1}(l,n);const u=l.get(i,!0);if(!u)return 1;if(!a)return function(e,t){if(e.range){const[r]=e.range,n=t.slice(0,r).split("\n").length;return s(e)?n:n-1}return 1}(u,n);if(r(u)){let e=1;return u.items.forEach((t=>{if(s(t)&&String(t.value)===String(a)&&t.range){const[r]=t.range;e=n.slice(0,r).split("\n").length}})),e}if(t(u)){let e=1;return u.items.forEach((t=>{const r=t.key,o=t.value;if(s(r)&&s(o)&&String(o.value)===String(a)&&o.range){const[t]=o.range;e=n.slice(0,t).split("\n").length}})),e}return 1}function w(e){if(s(e)){const t=String(e.value).split(/:(?![^[]*])/);return t[0].startsWith("[")&&t[0].endsWith("]")&&(t[0]=t[0].slice(1,-1)),f.isIP(t[0])?String(t[1]):t[0]}return t(e)&&e.get("published")?.toString()||""}class P{name="no-quotes-in-volumes";type="warning";category="style";severity="info";meta={description:"Ensure that quotes are not used in volume names in Docker Compose files.",url:"https://github.com/zavoloklom/docker-compose-linter/blob/main/docs/rules/no-quotes-in-volumes-rule.md"};fixable=!0;getMessage(){return"Quotes should not be used in volume names."}static extractVolumes(e,n){e&&t(e)&&e.items.forEach((e=>{if(!t(e.value))return;e.value.items.forEach((e=>{if(!t(e.value))return;const o=e.value.items.find((e=>s(e.key)&&"volumes"===e.key.value));o&&r(o.value)&&o.value.items.forEach((e=>{s(e)&&n(e)}))}))}))}check(e){const t=[],r=n(e.sourceCode);return P.extractVolumes(r.contents,(r=>{"PLAIN"!==r.type&&t.push({rule:this.name,type:this.type,category:this.category,severity:this.severity,message:this.getMessage(),line:b(e.sourceCode,String(r.value)),column:1,meta:this.meta,fixable:this.fixable})})),t}fix(e){const t=n(e);return P.extractVolumes(t.contents,(e=>{"PLAIN"!==e.type&&(e.type="PLAIN")})),t.toString()}}class k{name="require-quotes-in-ports";type="warning";category="best-practice";severity="minor";meta={description:"Ensure that ports (in `ports` and `expose` sections) are enclosed in quotes in Docker Compose files.",url:"https://github.com/zavoloklom/docker-compose-linter/blob/main/docs/rules/require-quotes-in-ports-rule.md"};fixable=!0;getMessage(){return"Ports in `ports` and `expose` sections should be enclosed in quotes."}quoteType;portsSections;constructor(e){this.quoteType=e?.quoteType||"single",this.portsSections=["ports","expose"]}getQuoteType(){return"single"===this.quoteType?"QUOTE_SINGLE":"QUOTE_DOUBLE"}static extractValues(e,n,o){e&&t(e)&&e.items.forEach((e=>{if(!t(e.value))return;e.value.items.forEach((e=>{if(!t(e.value))return;const i=e.value.items.find((e=>s(e.key)&&e.key.value===n));i&&r(i.value)&&i.value.items.forEach((t=>{s(t)&&o(e,t)}))}))}))}check(e){const t=[],r=n(e.sourceCode);return this.portsSections.forEach((s=>{k.extractValues(r.contents,s,((n,o)=>{o.type!==this.getQuoteType()&&t.push({rule:this.name,type:this.type,category:this.category,severity:this.severity,message:this.getMessage(),line:_(r,e.sourceCode,String(n.key),s,String(o.value)),column:1,meta:this.meta,fixable:this.fixable})}))})),t}fix(e){const t=n(e);return this.portsSections.forEach((e=>{k.extractValues(t.contents,e,((e,t)=>{if(t.type!==this.getQuoteType()){const e=new o(String(t.value));e.type=this.getQuoteType(),Object.assign(t,e)}}))})),t.toString()}}class S{name="service-container-name-regex";type="error";category="security";severity="critical";message="Container names must match the regex pattern [a-zA-Z0-9][a-zA-Z0-9_.-]+.";meta={description:"Ensure that container names in Docker Compose match the required regex pattern to avoid invalid names.",url:"https://github.com/zavoloklom/docker-compose-linter/blob/main/docs/rules/service-container-name-regex-rule.md"};fixable=!1;getMessage({serviceName:e,containerName:t}){return`Service "${e}" has an invalid container name "${t}". It must match the regex pattern ${S.containerNameRegex}.`}static containerNameRegex=/^[a-zA-Z0-9][a-zA-Z0-9_.-]+$/;check(e){const r=[],o=n(e.sourceCode),i=o.get("services");return t(i)?(i.items.forEach((n=>{if(!s(n.key))return;const i=String(n.key.value),a=n.value;if(!t(a)||!a.has("container_name"))return;const c=String(a.get("container_name"));if(!S.containerNameRegex.test(c)){const t=_(o,e.sourceCode,i,"container_name");r.push({rule:this.name,type:this.type,category:this.category,severity:this.severity,message:this.getMessage({serviceName:i,containerName:c}),line:t,column:1,meta:this.meta,fixable:this.fixable})}})),r):[]}}class E{name="service-dependencies-alphabetical-order";type="warning";category="style";severity="info";meta={description:"Ensure that the services listed in the depends_on directive are sorted alphabetically.",url:"https://github.com/zavoloklom/docker-compose-linter/blob/main/docs/rules/service-dependencies-alphabetical-order-rule.md"};fixable=!0;getMessage=({serviceName:e})=>`Services in "depends_on" for service "${e}" should be in alphabetical order.`;static extractServiceName(e){return s(e)?String(e.value):i(e)?String(e.key):""}check(e){const o=[],i=n(e.sourceCode),a=i.get("services");return t(a)?(a.items.forEach((n=>{if(!s(n.key))return;const a=String(n.key.value),c=n.value;if(!c||!t(c))return;const l=c.get("depends_on");if(!r(l)&&!t(l))return;const u=l.items.map((e=>E.extractServiceName(e))),d=[...u].sort(((e,t)=>e.localeCompare(t)));if(JSON.stringify(u)!==JSON.stringify(d)){const t=_(i,e.sourceCode,a,"depends_on");o.push({rule:this.name,type:this.type,category:this.category,severity:this.severity,message:this.getMessage({serviceName:a}),line:t,column:1,meta:this.meta,fixable:this.fixable})}})),o):[]}fix(e){const s=n(e),o=s.get("services");return t(o)?(o.items.forEach((e=>{const s=e.value;if(!s||!t(s))return;const n=s.get("depends_on");(r(n)||t(n))&&n.items.sort(((e,t)=>{const r=E.extractServiceName(e),s=E.extractServiceName(t);return r.localeCompare(s)}))})),s.toString()):e}}var j;!function(e){e.CoreDefinitions="Core Definitions",e.ServiceDependencies="Service Dependencies",e.DataManagementAndConfiguration="Data Management and Configuration",e.EnvironmentConfiguration="Environment Configuration",e.Networking="Networking",e.RuntimeBehavior="Runtime Behavior",e.OperationalMetadata="Operational Metadata",e.SecurityAndExecutionContext="Security and Execution Context",e.Other="Other"}(j||(j={}));const x=[j.CoreDefinitions,j.ServiceDependencies,j.DataManagementAndConfiguration,j.EnvironmentConfiguration,j.Networking,j.RuntimeBehavior,j.OperationalMetadata,j.SecurityAndExecutionContext,j.Other],N={[j.CoreDefinitions]:["image","build","container_name"],[j.ServiceDependencies]:["depends_on"],[j.DataManagementAndConfiguration]:["volumes","volumes_from","configs","secrets"],[j.EnvironmentConfiguration]:["environment","env_file"],[j.Networking]:["ports","networks","network_mode","extra_hosts"],[j.RuntimeBehavior]:["command","entrypoint","working_dir","restart","healthcheck"],[j.OperationalMetadata]:["logging","labels"],[j.SecurityAndExecutionContext]:["user","isolation"],[j.Other]:[]};class C{name="services-alphabetical-order";type="warning";category="style";severity="minor";message="Services should be listed in alphabetical order.";meta={description:"Ensure that services in the Docker Compose file are listed in alphabetical order.",url:"https://github.com/zavoloklom/docker-compose-linter/blob/main/docs/rules/services-alphabetical-order-rule.md"};fixable=!0;getMessage({serviceName:e,misplacedBefore:t}){return`Service "${e}" should be before "${t}".`}static findMisplacedService(e,t){let r="";return e.forEach((e=>{e.localeCompare(t)>0&&(!r||e.localeCompare(r)<0)&&(r=e)})),r}check(e){const r=[],o=n(e.sourceCode),i=o.get("services");if(!t(i))return[];const a=[];return i.items.forEach((t=>{if(!s(t.key))return;const n=String(t.key.value),i=C.findMisplacedService(a,n);if(i){const t=_(o,e.sourceCode,n);r.push({rule:this.name,type:this.type,category:this.category,severity:this.severity,message:this.getMessage({serviceName:n,misplacedBefore:i}),line:t,column:1,meta:this.meta,fixable:this.fixable})}a.push(n)})),r}fix(e){const r=n(e),o=r.get("services");if(!t(o))return e;const i=new a;return o.items.sort(((e,t)=>s(e.key)&&s(t.key)?String(e.key.value).localeCompare(String(t.key.value)):0)).forEach((e=>{i.add(e)})),r.set("services",i),r.toString()}}var O;!function(e){e.XProperties="x-properties",e.Version="version",e.Name="name",e.Include="include",e.Services="services",e.Networks="networks",e.Volumes="volumes",e.Secrets="secrets",e.Configs="configs"}(O||(O={}));const I=[O.XProperties,O.Version,O.Name,O.Include,O.Services,O.Networks,O.Volumes,O.Secrets,O.Configs];var R={NoBuildAndImageRule:class{name="no-build-and-image";type="error";category="best-practice";severity="major";meta={description:'Ensure that each service uses either "build" or "image", but not both, to prevent ambiguity in Docker Compose configurations.',url:"https://github.com/zavoloklom/docker-compose-linter/blob/main/docs/rules/no-build-and-image-rule.md"};fixable=!1;checkPullPolicy;constructor(e){this.checkPullPolicy=e?.checkPullPolicy??!0}getMessage({serviceName:e}){return`Service "${e}" is using both "build" and "image". Use either "build" or "image" but not both.`}check(e){const r=[],o=n(e.sourceCode),i=o.get("services");return t(i)?(i.items.forEach((n=>{if(!s(n.key))return;const i=String(n.key.value),a=n.value;if(!t(a))return;const c=a.has("build"),l=a.has("image"),u=a.has("pull_policy");if(c&&l&&(!this.checkPullPolicy||!u)){const t=_(o,e.sourceCode,i,"build");r.push({rule:this.name,type:this.type,category:this.category,severity:this.severity,message:this.getMessage({serviceName:i}),line:t,column:1,meta:this.meta,fixable:this.fixable})}})),r):[]}},NoDuplicateContainerNamesRule:class{name="no-duplicate-container-names";type="error";category="security";severity="critical";meta={description:"Ensure that container names in Docker Compose are unique to prevent name conflicts and ensure proper container management.",url:"https://github.com/zavoloklom/docker-compose-linter/blob/main/docs/rules/no-duplicate-container-names-rule.md"};fixable=!1;getMessage({serviceName:e,containerName:t,anotherService:r}){return`Service "${e}" has a duplicate container name "${t}" with service "${r}". Container names MUST BE unique.`}check(e){const r=[],o=n(e.sourceCode),i=o.get("services");if(!t(i))return[];const a=new Map;return i.items.forEach((n=>{if(!s(n.key))return;const i=String(n.key.value),c=n.value;if(t(c)&&c.has("container_name")){const t=String(c.get("container_name"));if(a.has(t)){const s=_(o,e.sourceCode,i,"container_name");r.push({rule:this.name,type:this.type,category:this.category,severity:this.severity,message:this.getMessage({serviceName:i,containerName:t,anotherService:String(a.get(t))}),line:s,column:1,meta:this.meta,fixable:this.fixable})}else a.set(t,i)}})),r}},NoDuplicateExportedPortsRule:class{name="no-duplicate-exported-ports";type="error";category="security";severity="critical";meta={description:"Ensure that exported ports in Docker Compose are unique to prevent port conflicts and ensure proper network behavior.",url:"https://github.com/zavoloklom/docker-compose-linter/blob/main/docs/rules/no-duplicate-exported-ports-rule.md"};fixable=!1;getMessage({serviceName:e,publishedPort:t,anotherService:r}){return`Service "${e}" is exporting port "${t}" which is already used by service "${r}".`}check(e){const o=[],i=n(e.sourceCode),a=i.get("services");if(!t(a))return[];const c=new Map;return a.items.forEach((n=>{if(!s(n.key))return;const a=String(n.key.value),l=n.value;if(!t(l)||!l.has("ports"))return;const u=l.get("ports");r(u)&&u.items.forEach((t=>{const r=w(t),s=function(e){const[t,r]=e.split("-").map(Number);if(Number.isNaN(t)||Number.isNaN(r))return[];if(!r)return[t.toString()];if(t>r)return[];const s=[];for(let e=t;e<=r;e++)s.push(e.toString());return s}(r);s.some((t=>{if(c.has(t)){const s=_(i,e.sourceCode,a,"ports");return o.push({rule:this.name,type:this.type,category:this.category,severity:this.severity,message:this.getMessage({serviceName:a,publishedPort:r,anotherService:String(c.get(t))}),line:s,column:1,meta:this.meta,fixable:this.fixable}),!0}return!1})),s.forEach((e=>!c.has(e)&&c.set(e,a)))}))})),o}},NoQuotesInVolumesRule:P,NoUnboundPortInterfacesRule:class{name="no-unbound-port-interfaces";type="error";category="security";severity="major";meta={description:"Ensure that exported ports in Docker Compose are bound to specific Interfaces to prevent unintentional exposing services to the network.",url:"https://github.com/zavoloklom/docker-compose-linter/blob/main/docs/rules/no-unbound-port-interfaces-rule.md"};fixable=!1;getMessage({serviceName:e,port:t}){return`Service "${e}" is exporting port "${t}" without specifying the interface to listen on.`}check(e){const o=[],i=n(e.sourceCode),a=i.get("services");return t(a)?(a.items.forEach((n=>{if(!s(n.key))return;const a=String(n.key.value),c=n.value;if(!t(c)||!c.has("ports"))return;const l=c.get("ports");r(l)&&l.items.forEach((n=>{if(""===function(e){if(s(e)){const t=String(e.value).split(/:(?![^[]*])/);return t[0].startsWith("[")&&t[0].endsWith("]")&&(t[0]=t[0].slice(1,-1)),f.isIP(t[0])?String(t[0]):""}return t(e)&&e.get("host_ip")?.toString()||""}(n)){const t=_(i,e.sourceCode,a,"ports");o.push({rule:this.name,type:this.type,category:this.category,severity:this.severity,message:this.getMessage({serviceName:a,port:r(n)?n.toString():String(n)}),line:t,column:1,meta:this.meta,fixable:this.fixable})}}))})),o):[]}},NoVersionFieldRule:class{name="no-version-field";type="error";category="best-practice";severity="minor";meta={description:'Ensure that the "version" field is not present in the Docker Compose file.',url:"https://github.com/zavoloklom/docker-compose-linter/blob/main/docs/rules/no-version-field-rule.md"};fixable=!0;getMessage(){return'The "version" field should not be present.'}check(e){const t=[];return e.content&&"version"in e.content&&t.push({rule:this.name,type:this.type,category:this.category,severity:this.severity,message:this.getMessage(),line:$(e.sourceCode,"version"),column:1,meta:this.meta,fixable:this.fixable}),t}fix(e){const t=e.split("\n"),r=t.findIndex((e=>e.trim().startsWith("version:")));return-1!==r&&t.splice(r,1),t.join("\n")}},RequireProjectNameFieldRule:class{name="require-project-name-field";type="warning";category="best-practice";severity="minor";meta={description:'Ensure that the "name" field is present in the Docker Compose file.',url:"https://github.com/zavoloklom/docker-compose-linter/blob/main/docs/rules/require-project-name-field-rule.md"};fixable=!1;getMessage(){return'The "name" field should be present.'}check(e){const t=[];return e.content&&!("name"in e.content)&&t.push({rule:this.name,type:this.type,category:this.category,severity:this.severity,message:this.getMessage(),line:1,column:1,meta:this.meta,fixable:this.fixable}),t}},RequireQuotesInPortsRule:k,ServiceContainerNameRegexRule:S,ServiceDependenciesAlphabeticalOrderRule:E,ServiceImageRequireExplicitTagRule:class{name="service-image-require-explicit-tag";type="error";category="security";severity="major";meta={description:'Avoid using unspecific image tags like "latest" or "stable" in Docker Compose files to prevent unpredictable behavior. Specify a specific image version.',url:"https://github.com/zavoloklom/docker-compose-linter/blob/main/docs/rules/service-image-require-explicit-tag-rule.md"};fixable=!1;getMessage({serviceName:e,image:t}){return`Service "${e}" is using the image "${t}", which does not have a concrete version tag. Specify a concrete version tag.`}prohibitedTags;constructor(e){this.prohibitedTags=e?.prohibitedTags||["latest","stable","edge","test","nightly","dev","beta","canary"]}isImageTagExplicit(e){const t=e.split("/").pop();if(!t||!t.includes(":"))return!1;const[,r]=t.split(":");return!this.prohibitedTags.includes(r)}check(e){const r=[],o=n(e.sourceCode),i=o.get("services");return t(i)?(i.items.forEach((n=>{if(!s(n.key))return;const i=String(n.key.value),a=n.value;if(!t(a)||!a.has("image"))return;const c=String(a.get("image"));if(!this.isImageTagExplicit(c)){const t=_(o,e.sourceCode,i,"image");r.push({rule:this.name,type:this.type,category:this.category,severity:this.severity,message:this.getMessage({serviceName:i,image:c}),line:t,column:1,meta:this.meta,fixable:this.fixable})}})),r):[]}},ServiceKeysOrderRule:class{name="service-keys-order";type="warning";category="style";severity="minor";message="Keys within each service should follow the predefined order.";meta={description:"Ensure that keys within each service in the Docker Compose file are ordered correctly.",url:"https://github.com/zavoloklom/docker-compose-linter/blob/main/docs/rules/service-keys-order-rule.md"};fixable=!0;getMessage({serviceName:e,key:t,correctOrder:r}){return`Key "${t}" in service "${e}" is out of order. Expected order is: ${r.join(", ")}.`}groupOrder;groups;constructor(e){this.groupOrder=e?.groupOrder?.length?e.groupOrder:x,this.groups={...N},e?.groups&&Object.keys(e.groups).forEach((t=>{const r=t;N[r]&&e.groups&&(this.groups[r]=e.groups[r])}))}getCorrectOrder(e){const t=e.filter((e=>!Object.values(this.groups).flat().includes(e))).sort();return[...this.groupOrder.flatMap((e=>this.groups[e])),...t]}check(e){const r=[],o=n(e.sourceCode),i=o.get("services");return t(i)?(i.items.forEach((n=>{if(!s(n.key))return;const i=String(n.key.value),a=n.value;if(!t(a))return;const c=a.items.map((e=>String(e.key))),l=this.getCorrectOrder(c);let u=-1;c.forEach((t=>{const s=l.indexOf(t);if(-1!==s){if(s<u){const s=_(o,e.sourceCode,i,t);r.push({rule:this.name,type:this.type,category:this.category,severity:this.severity,message:this.getMessage({serviceName:i,key:t,correctOrder:l}),line:s,column:1,meta:this.meta,fixable:this.fixable})}u=s}}))})),r):[]}fix(e){const r=n(e),o=r.get("services");return t(o)?(o.items.forEach((e=>{if(!s(e.key))return;const r=String(e.key.value),n=e.value;if(!t(n))return;const i=n.items.map((e=>s(e.key)?String(e.key.value):"")).filter(Boolean),c=this.getCorrectOrder(i),l=new a;c.forEach((e=>{const t=n.items.find((t=>s(t.key)&&t.key.value===e));t&&l.add(t)})),i.forEach((e=>{if(!c.includes(e)){const t=n.items.find((t=>s(t.key)&&t.key.value===e));t&&l.add(t)}})),o.set(r,l)})),r.toString()):e}},ServicePortsAlphabeticalOrderRule:class{name="service-ports-alphabetical-order";type="warning";category="style";severity="info";meta={description:"Ensure that the list of ports in the Docker Compose service is alphabetically sorted.",url:"https://github.com/zavoloklom/docker-compose-linter/blob/main/docs/rules/service-ports-alphabetical-order-rule.md"};fixable=!0;getMessage({serviceName:e}){return`Ports in service "${e}" should be in alphabetical order.`}check(e){const o=[],i=n(e.sourceCode),a=i.get("services");return t(a)?(a.items.forEach((n=>{if(!s(n.key))return;const a=String(n.key.value),c=n.value;if(!t(c)||!r(c.get("ports")))return;const l=c.get("ports");if(!r(l))return;const u=l.items.map((e=>w(e))),d=[...u].sort(((e,t)=>e.localeCompare(t,void 0,{numeric:!0})));if(JSON.stringify(u)!==JSON.stringify(d)){const t=_(i,e.sourceCode,a,"ports");o.push({rule:this.name,type:this.type,category:this.category,severity:this.severity,message:`Ports in service "${a}" should be in alphabetical order.`,line:t,column:1,meta:this.meta,fixable:this.fixable})}})),o):[]}fix(e){const s=n(e),o=s.get("services");return t(o)?(o.items.forEach((e=>{const s=e.value;if(!t(s)||!r(s.get("ports")))return;const n=s.get("ports");r(n)&&n.items.sort(((e,t)=>{const r=w(e),s=w(t);return r.localeCompare(s,void 0,{numeric:!0})}))})),s.toString()):e}},ServicesAlphabeticalOrderRule:C,TopLevelPropertiesOrderRule:class{name="top-level-properties-order";type="warning";category="style";severity="major";message="Top-level properties should follow the predefined order.";meta={description:"Ensure that top-level properties in the Docker Compose file are ordered correctly.",url:"https://github.com/zavoloklom/docker-compose-linter/blob/main/docs/rules/top-level-properties-order-rule.md"};fixable=!0;getMessage({key:e,correctOrder:t}){return`Property "${e}" is out of order. Expected order is: ${t.join(", ")}.`}expectedOrder;constructor(e){this.expectedOrder=e?.customOrder??I}check(e){const t=[],r=Object.keys(e.content),s=r.filter((e=>e.startsWith("x-"))).sort(),n=this.expectedOrder.flatMap((e=>e===O.XProperties?s:[e]));let o=-1;return r.forEach((r=>{const s=n.indexOf(r);if(-1===s||s<o){const s=$(e.sourceCode,r);t.push({rule:this.name,type:this.type,category:this.category,severity:this.severity,message:this.getMessage({key:r,correctOrder:n}),line:s,column:1,meta:this.meta,fixable:this.fixable})}else o=s})),t}fix(e){const r=n(e),{contents:o}=r;if(!t(o))return e;const i=o.items.map((e=>s(e.key)?String(e.key.value):"")).filter(Boolean).filter((e=>e.startsWith("x-"))).sort(),c=this.expectedOrder.flatMap((e=>e===O.XProperties?i:[e])),l=new a;return c.forEach((e=>{const t=o.items.find((t=>s(t.key)&&String(t.key.value)===e));t&&l.items.push(t)})),r.contents=l,r.toString()}}};var T,M={exports:{}},A={},D={},V={},q={},z={},U={};function L(){return T||(T=1,function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.regexpCode=e.getEsmExportName=e.getProperty=e.safeStringify=e.stringify=e.strConcat=e.addCodeArg=e.str=e._=e.nil=e._Code=e.Name=e.IDENTIFIER=e._CodeOrName=void 0;class t{}e._CodeOrName=t,e.IDENTIFIER=/^[a-z$_][a-z$_0-9]*$/i;class r extends t{constructor(t){if(super(),!e.IDENTIFIER.test(t))throw new Error("CodeGen: name must be a valid identifier");this.str=t}toString(){return this.str}emptyStr(){return!1}get names(){return{[this.str]:1}}}e.Name=r;class s extends t{constructor(e){super(),this._items="string"==typeof e?[e]:e}toString(){return this.str}emptyStr(){if(this._items.length>1)return!1;const e=this._items[0];return""===e||'""'===e}get str(){var e;return null!==(e=this._str)&&void 0!==e?e:this._str=this._items.reduce(((e,t)=>`${e}${t}`),"")}get names(){var e;return null!==(e=this._names)&&void 0!==e?e:this._names=this._items.reduce(((e,t)=>(t instanceof r&&(e[t.str]=(e[t.str]||0)+1),e)),{})}}function n(e,...t){const r=[e[0]];let n=0;for(;n<t.length;)a(r,t[n]),r.push(e[++n]);return new s(r)}e._Code=s,e.nil=new s(""),e._=n;const o=new s("+");function i(e,...t){const r=[l(e[0])];let n=0;for(;n<t.length;)r.push(o),a(r,t[n]),r.push(o,l(e[++n]));return function(e){let t=1;for(;t<e.length-1;){if(e[t]===o){const r=c(e[t-1],e[t+1]);if(void 0!==r){e.splice(t-1,3,r);continue}e[t++]="+"}t++}}(r),new s(r)}function a(e,t){var n;t instanceof s?e.push(...t._items):t instanceof r?e.push(t):e.push("number"==typeof(n=t)||"boolean"==typeof n||null===n?n:l(Array.isArray(n)?n.join(","):n))}function c(e,t){if('""'===t)return e;if('""'===e)return t;if("string"==typeof e){if(t instanceof r||'"'!==e[e.length-1])return;return"string"!=typeof t?`${e.slice(0,-1)}${t}"`:'"'===t[0]?e.slice(0,-1)+t.slice(1):void 0}return"string"!=typeof t||'"'!==t[0]||e instanceof r?void 0:`"${e}${t.slice(1)}`}function l(e){return JSON.stringify(e).replace(/\u2028/g,"\\u2028").replace(/\u2029/g,"\\u2029")}e.str=i,e.addCodeArg=a,e.strConcat=function(e,t){return t.emptyStr()?e:e.emptyStr()?t:i`${e}${t}`},e.stringify=function(e){return new s(l(e))},e.safeStringify=l,e.getProperty=function(t){return"string"==typeof t&&e.IDENTIFIER.test(t)?new s(`.${t}`):n`[${t}]`},e.getEsmExportName=function(t){if("string"==typeof t&&e.IDENTIFIER.test(t))return new s(`${t}`);throw new Error(`CodeGen: invalid export name: ${t}, use explicit $id name mapping`)},e.regexpCode=function(e){return new s(e.toString())}}(U)),U}var F,K,G={};function B(){return F||(F=1,function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.ValueScope=e.ValueScopeName=e.Scope=e.varKinds=e.UsedValueState=void 0;const t=L();class r extends Error{constructor(e){super(`CodeGen: "code" for ${e} not defined`),this.value=e.value}}var s;!function(e){e[e.Started=0]="Started",e[e.Completed=1]="Completed"}(s||(e.UsedValueState=s={})),e.varKinds={const:new t.Name("const"),let:new t.Name("let"),var:new t.Name("var")};class n{constructor({prefixes:e,parent:t}={}){this._names={},this._prefixes=e,this._parent=t}toName(e){return e instanceof t.Name?e:this.name(e)}name(e){return new t.Name(this._newName(e))}_newName(e){return`${e}${(this._names[e]||this._nameGroup(e)).index++}`}_nameGroup(e){var t,r;if((null===(r=null===(t=this._parent)||void 0===t?void 0:t._prefixes)||void 0===r?void 0:r.has(e))||this._prefixes&&!this._prefixes.has(e))throw new Error(`CodeGen: prefix "${e}" is not allowed in this scope`);return this._names[e]={prefix:e,index:0}}}e.Scope=n;class o extends t.Name{constructor(e,t){super(t),this.prefix=e}setValue(e,{property:r,itemIndex:s}){this.value=e,this.scopePath=t._`.${new t.Name(r)}[${s}]`}}e.ValueScopeName=o;const i=t._`\n`;e.ValueScope=class extends n{constructor(e){super(e),this._values={},this._scope=e.scope,this.opts={...e,_n:e.lines?i:t.nil}}get(){return this._scope}name(e){return new o(e,this._newName(e))}value(e,t){var r;if(void 0===t.ref)throw new Error("CodeGen: ref must be passed in value");const s=this.toName(e),{prefix:n}=s,o=null!==(r=t.key)&&void 0!==r?r:t.ref;let i=this._values[n];if(i){const e=i.get(o);if(e)return e}else i=this._values[n]=new Map;i.set(o,s);const a=this._scope[n]||(this._scope[n]=[]),c=a.length;return a[c]=t.ref,s.setValue(t,{property:n,itemIndex:c}),s}getValue(e,t){const r=this._values[e];if(r)return r.get(t)}scopeRefs(e,r=this._values){return this._reduceValues(r,(r=>{if(void 0===r.scopePath)throw new Error(`CodeGen: name "${r}" has no value`);return t._`${e}${r.scopePath}`}))}scopeCode(e=this._values,t,r){return this._reduceValues(e,(e=>{if(void 0===e.value)throw new Error(`CodeGen: name "${e}" has no value`);return e.value.code}),t,r)}_reduceValues(n,o,i={},a){let c=t.nil;for(const l in n){const u=n[l];if(!u)continue;const d=i[l]=i[l]||new Map;u.forEach((n=>{if(d.has(n))return;d.set(n,s.Started);let i=o(n);if(i){const r=this.opts.es5?e.varKinds.var:e.varKinds.const;c=t._`${c}${r} ${n} = ${i};${this.opts._n}`}else{if(!(i=null==a?void 0:a(n)))throw new r(n);c=t._`${c}${i}${this.opts._n}`}d.set(n,s.Completed)}))}return c}}}(G)),G}function J(){return K||(K=1,function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.or=e.and=e.not=e.CodeGen=e.operators=e.varKinds=e.ValueScopeName=e.ValueScope=e.Scope=e.Name=e.regexpCode=e.stringify=e.getProperty=e.nil=e.strConcat=e.str=e._=void 0;const t=L(),r=B();var s=L();Object.defineProperty(e,"_",{enumerable:!0,get:function(){return s._}}),Object.defineProperty(e,"str",{enumerable:!0,get:function(){return s.str}}),Object.defineProperty(e,"strConcat",{enumerable:!0,get:function(){return s.strConcat}}),Object.defineProperty(e,"nil",{enumerable:!0,get:function(){return s.nil}}),Object.defineProperty(e,"getProperty",{enumerable:!0,get:function(){return s.getProperty}}),Object.defineProperty(e,"stringify",{enumerable:!0,get:function(){return s.stringify}}),Object.defineProperty(e,"regexpCode",{enumerable:!0,get:function(){return s.regexpCode}}),Object.defineProperty(e,"Name",{enumerable:!0,get:function(){return s.Name}});var n=B();Object.defineProperty(e,"Scope",{enumerable:!0,get:function(){return n.Scope}}),Object.defineProperty(e,"ValueScope",{enumerable:!0,get:function(){return n.ValueScope}}),Object.defineProperty(e,"ValueScopeName",{enumerable:!0,get:function(){return n.ValueScopeName}}),Object.defineProperty(e,"varKinds",{enumerable:!0,get:function(){return n.varKinds}}),e.operators={GT:new t._Code(">"),GTE:new t._Code(">="),LT:new t._Code("<"),LTE:new t._Code("<="),EQ:new t._Code("==="),NEQ:new t._Code("!=="),NOT:new t._Code("!"),OR:new t._Code("||"),AND:new t._Code("&&"),ADD:new t._Code("+")};class o{optimizeNodes(){return this}optimizeNames(e,t){return this}}class i extends o{constructor(e,t,r){super(),this.varKind=e,this.name=t,this.rhs=r}render({es5:e,_n:t}){const s=e?r.varKinds.var:this.varKind,n=void 0===this.rhs?"":` = ${this.rhs}`;return`${s} ${this.name}${n};`+t}optimizeNames(e,t){if(e[this.name.str])return this.rhs&&(this.rhs=N(this.rhs,e,t)),this}get names(){return this.rhs instanceof t._CodeOrName?this.rhs.names:{}}}class a extends o{constructor(e,t,r){super(),this.lhs=e,this.rhs=t,this.sideEffects=r}render({_n:e}){return`${this.lhs} = ${this.rhs};`+e}optimizeNames(e,r){if(!(this.lhs instanceof t.Name)||e[this.lhs.str]||this.sideEffects)return this.rhs=N(this.rhs,e,r),this}get names(){return x(this.lhs instanceof t.Name?{}:{...this.lhs.names},this.rhs)}}class c extends a{constructor(e,t,r,s){super(e,r,s),this.op=t}render({_n:e}){return`${this.lhs} ${this.op}= ${this.rhs};`+e}}class l extends o{constructor(e){super(),this.label=e,this.names={}}render({_n:e}){return`${this.label}:`+e}}class u extends o{constructor(e){super(),this.label=e,this.names={}}render({_n:e}){return`break${this.label?` ${this.label}`:""};`+e}}class d extends o{constructor(e){super(),this.error=e}render({_n:e}){return`throw ${this.error};`+e}get names(){return this.error.names}}class p extends o{constructor(e){super(),this.code=e}render({_n:e}){return`${this.code};`+e}optimizeNodes(){return`${this.code}`?this:void 0}optimizeNames(e,t){return this.code=N(this.code,e,t),this}get names(){return this.code instanceof t._CodeOrName?this.code.names:{}}}class f extends o{constructor(e=[]){super(),this.nodes=e}render(e){return this.nodes.reduce(((t,r)=>t+r.render(e)),"")}optimizeNodes(){const{nodes:e}=this;let t=e.length;for(;t--;){const r=e[t].optimizeNodes();Array.isArray(r)?e.splice(t,1,...r):r?e[t]=r:e.splice(t,1)}return e.length>0?this:void 0}optimizeNames(e,t){const{nodes:r}=this;let s=r.length;for(;s--;){const n=r[s];n.optimizeNames(e,t)||(C(e,n.names),r.splice(s,1))}return r.length>0?this:void 0}get names(){return this.nodes.reduce(((e,t)=>j(e,t.names)),{})}}class m extends f{render(e){return"{"+e._n+super.render(e)+"}"+e._n}}class h extends f{}class y extends m{}y.kind="else";class g extends m{constructor(e,t){super(t),this.condition=e}render(e){let t=`if(${this.condition})`+super.render(e);return this.else&&(t+="else "+this.else.render(e)),t}optimizeNodes(){super.optimizeNodes();const e=this.condition;if(!0===e)return this.nodes;let t=this.else;if(t){const e=t.optimizeNodes();t=this.else=Array.isArray(e)?new y(e):e}return t?!1===e?t instanceof g?t:t.nodes:this.nodes.length?this:new g(O(e),t instanceof g?[t]:t.nodes):!1!==e&&this.nodes.length?this:void 0}optimizeNames(e,t){var r;if(this.else=null===(r=this.else)||void 0===r?void 0:r.optimizeNames(e,t),super.optimizeNames(e,t)||this.else)return this.condition=N(this.condition,e,t),this}get names(){const e=super.names;return x(e,this.condition),this.else&&j(e,this.else.names),e}}g.kind="if";class v extends m{}v.kind="for";class $ extends v{constructor(e){super(),this.iteration=e}render(e){return`for(${this.iteration})`+super.render(e)}optimizeNames(e,t){if(super.optimizeNames(e,t))return this.iteration=N(this.iteration,e,t),this}get names(){return j(super.names,this.iteration.names)}}class b extends v{constructor(e,t,r,s){super(),this.varKind=e,this.name=t,this.from=r,this.to=s}render(e){const t=e.es5?r.varKinds.var:this.varKind,{name:s,from:n,to:o}=this;return`for(${t} ${s}=${n}; ${s}<${o}; ${s}++)`+super.render(e)}get names(){const e=x(super.names,this.from);return x(e,this.to)}}class _ extends v{constructor(e,t,r,s){super(),this.loop=e,this.varKind=t,this.name=r,this.iterable=s}render(e){return`for(${this.varKind} ${this.name} ${this.loop} ${this.iterable})`+super.render(e)}optimizeNames(e,t){if(super.optimizeNames(e,t))return this.iterable=N(this.iterable,e,t),this}get names(){return j(super.names,this.iterable.names)}}class w extends m{constructor(e,t,r){super(),this.name=e,this.args=t,this.async=r}render(e){return`${this.async?"async ":""}function ${this.name}(${this.args})`+super.render(e)}}w.kind="func";class P extends f{render(e){return"return "+super.render(e)}}P.kind="return";class k extends m{render(e){let t="try"+super.render(e);return this.catch&&(t+=this.catch.render(e)),this.finally&&(t+=this.finally.render(e)),t}optimizeNodes(){var e,t;return super.optimizeNodes(),null===(e=this.catch)||void 0===e||e.optimizeNodes(),null===(t=this.finally)||void 0===t||t.optimizeNodes(),this}optimizeNames(e,t){var r,s;return super.optimizeNames(e,t),null===(r=this.catch)||void 0===r||r.optimizeNames(e,t),null===(s=this.finally)||void 0===s||s.optimizeNames(e,t),this}get names(){const e=super.names;return this.catch&&j(e,this.catch.names),this.finally&&j(e,this.finally.names),e}}class S extends m{constructor(e){super(),this.error=e}render(e){return`catch(${this.error})`+super.render(e)}}S.kind="catch";class E extends m{render(e){return"finally"+super.render(e)}}E.kind="finally";function j(e,t){for(const r in t)e[r]=(e[r]||0)+(t[r]||0);return e}function x(e,r){return r instanceof t._CodeOrName?j(e,r.names):e}function N(e,r,s){return e instanceof t.Name?o(e):(n=e)instanceof t._Code&&n._items.some((e=>e instanceof t.Name&&1===r[e.str]&&void 0!==s[e.str]))?new t._Code(e._items.reduce(((e,r)=>(r instanceof t.Name&&(r=o(r)),r instanceof t._Code?e.push(...r._items):e.push(r),e)),[])):e;var n;function o(e){const t=s[e.str];return void 0===t||1!==r[e.str]?e:(delete r[e.str],t)}}function C(e,t){for(const r in t)e[r]=(e[r]||0)-(t[r]||0)}function O(e){return"boolean"==typeof e||"number"==typeof e||null===e?!e:t._`!${M(e)}`}e.CodeGen=class{constructor(e,t={}){this._values={},this._blockStarts=[],this._constants={},this.opts={...t,_n:t.lines?"\n":""},this._extScope=e,this._scope=new r.Scope({parent:e}),this._nodes=[new h]}toString(){return this._root.render(this.opts)}name(e){return this._scope.name(e)}scopeName(e){return this._extScope.name(e)}scopeValue(e,t){const r=this._extScope.value(e,t);return(this._values[r.prefix]||(this._values[r.prefix]=new Set)).add(r),r}getScopeValue(e,t){return this._extScope.getValue(e,t)}scopeRefs(e){return this._extScope.scopeRefs(e,this._values)}scopeCode(){return this._extScope.scopeCode(this._values)}_def(e,t,r,s){const n=this._scope.toName(t);return void 0!==r&&s&&(this._constants[n.str]=r),this._leafNode(new i(e,n,r)),n}const(e,t,s){return this._def(r.varKinds.const,e,t,s)}let(e,t,s){return this._def(r.varKinds.let,e,t,s)}var(e,t,s){return this._def(r.varKinds.var,e,t,s)}assign(e,t,r){return this._leafNode(new a(e,t,r))}add(t,r){return this._leafNode(new c(t,e.operators.ADD,r))}code(e){return"function"==typeof e?e():e!==t.nil&&this._leafNode(new p(e)),this}object(...e){const r=["{"];for(const[s,n]of e)r.length>1&&r.push(","),r.push(s),(s!==n||this.opts.es5)&&(r.push(":"),(0,t.addCodeArg)(r,n));return r.push("}"),new t._Code(r)}if(e,t,r){if(this._blockNode(new g(e)),t&&r)this.code(t).else().code(r).endIf();else if(t)this.code(t).endIf();else if(r)throw new Error('CodeGen: "else" body without "then" body');return this}elseIf(e){return this._elseNode(new g(e))}else(){return this._elseNode(new y)}endIf(){return this._endBlockNode(g,y)}_for(e,t){return this._blockNode(e),t&&this.code(t).endFor(),this}for(e,t){return this._for(new $(e),t)}forRange(e,t,s,n,o=(this.opts.es5?r.varKinds.var:r.varKinds.let)){const i=this._scope.toName(e);return this._for(new b(o,i,t,s),(()=>n(i)))}forOf(e,s,n,o=r.varKinds.const){const i=this._scope.toName(e);if(this.opts.es5){const e=s instanceof t.Name?s:this.var("_arr",s);return this.forRange("_i",0,t._`${e}.length`,(r=>{this.var(i,t._`${e}[${r}]`),n(i)}))}return this._for(new _("of",o,i,s),(()=>n(i)))}forIn(e,s,n,o=(this.opts.es5?r.varKinds.var:r.varKinds.const)){if(this.opts.ownProperties)return this.forOf(e,t._`Object.keys(${s})`,n);const i=this._scope.toName(e);return this._for(new _("in",o,i,s),(()=>n(i)))}endFor(){return this._endBlockNode(v)}label(e){return this._leafNode(new l(e))}break(e){return this._leafNode(new u(e))}return(e){const t=new P;if(this._blockNode(t),this.code(e),1!==t.nodes.length)throw new Error('CodeGen: "return" should have one node');return this._endBlockNode(P)}try(e,t,r){if(!t&&!r)throw new Error('CodeGen: "try" without "catch" and "finally"');const s=new k;if(this._blockNode(s),this.code(e),t){const e=this.name("e");this._currNode=s.catch=new S(e),t(e)}return r&&(this._currNode=s.finally=new E,this.code(r)),this._endBlockNode(S,E)}throw(e){return this._leafNode(new d(e))}block(e,t){return this._blockStarts.push(this._nodes.length),e&&this.code(e).endBlock(t),this}endBlock(e){const t=this._blockStarts.pop();if(void 0===t)throw new Error("CodeGen: not in self-balancing block");const r=this._nodes.length-t;if(r<0||void 0!==e&&r!==e)throw new Error(`CodeGen: wrong number of nodes: ${r} vs ${e} expected`);return this._nodes.length=t,this}func(e,r=t.nil,s,n){return this._blockNode(new w(e,r,s)),n&&this.code(n).endFunc(),this}endFunc(){return this._endBlockNode(w)}optimize(e=1){for(;e-- >0;)this._root.optimizeNodes(),this._root.optimizeNames(this._root.names,this._constants)}_leafNode(e){return this._currNode.nodes.push(e),this}_blockNode(e){this._currNode.nodes.push(e),this._nodes.push(e)}_endBlockNode(e,t){const r=this._currNode;if(r instanceof e||t&&r instanceof t)return this._nodes.pop(),this;throw new Error(`CodeGen: not in block "${t?`${e.kind}/${t.kind}`:e.kind}"`)}_elseNode(e){const t=this._currNode;if(!(t instanceof g))throw new Error('CodeGen: "else" without "if"');return this._currNode=t.else=e,this}get _root(){return this._nodes[0]}get _currNode(){const e=this._nodes;return e[e.length-1]}set _currNode(e){const t=this._nodes;t[t.length-1]=e}},e.not=O;const I=T(e.operators.AND);e.and=function(...e){return e.reduce(I)};const R=T(e.operators.OR);function T(e){return(r,s)=>r===t.nil?s:s===t.nil?r:t._`${M(r)} ${e} ${M(s)}`}function M(e){return e instanceof t.Name?e:t._`(${e})`}e.or=function(...e){return e.reduce(R)}}(z)),z}var H,W={};function Z(){if(H)return W;H=1,Object.defineProperty(W,"__esModule",{value:!0}),W.checkStrictMode=W.getErrorPath=W.Type=W.useFunc=W.setEvaluated=W.evaluatedPropsToName=W.mergeEvaluated=W.eachItem=W.unescapeJsonPointer=W.escapeJsonPointer=W.escapeFragment=W.unescapeFragment=W.schemaRefOrVal=W.schemaHasRulesButRef=W.schemaHasRules=W.checkUnknownRules=W.alwaysValidSchema=W.toHash=void 0;const e=J(),t=L();function r(e,t=e.schema){const{opts:r,self:s}=e;if(!r.strictSchema)return;if("boolean"==typeof t)return;const n=s.RULES.keywords;for(const r in t)n[r]||d(e,`unknown keyword: "${r}"`)}function s(e,t){if("boolean"==typeof e)return!e;for(const r in e)if(t[r])return!0;return!1}function n(e){return"number"==typeof e?`${e}`:e.replace(/~/g,"~0").replace(/\//g,"~1")}function o(e){return e.replace(/~1/g,"/").replace(/~0/g,"~")}function i({mergeNames:t,mergeToName:r,mergeValues:s,resultToName:n}){return(o,i,a,c)=>{const l=void 0===a?i:a instanceof e.Name?(i instanceof e.Name?t(o,i,a):r(o,i,a),a):i instanceof e.Name?(r(o,a,i),i):s(i,a);return c!==e.Name||l instanceof e.Name?l:n(o,l)}}function a(t,r){if(!0===r)return t.var("props",!0);const s=t.var("props",e._`{}`);return void 0!==r&&c(t,s,r),s}function c(t,r,s){Object.keys(s).forEach((s=>t.assign(e._`${r}${(0,e.getProperty)(s)}`,!0)))}W.toHash=function(e){const t={};for(const r of e)t[r]=!0;return t},W.alwaysValidSchema=function(e,t){return"boolean"==typeof t?t:0===Object.keys(t).length||(r(e,t),!s(t,e.self.RULES.all))},W.checkUnknownRules=r,W.schemaHasRules=s,W.schemaHasRulesButRef=function(e,t){if("boolean"==typeof e)return!e;for(const r in e)if("$ref"!==r&&t.all[r])return!0;return!1},W.schemaRefOrVal=function({topSchemaRef:t,schemaPath:r},s,n,o){if(!o){if("number"==typeof s||"boolean"==typeof s)return s;if("string"==typeof s)return e._`${s}`}return e._`${t}${r}${(0,e.getProperty)(n)}`},W.unescapeFragment=function(e){return o(decodeURIComponent(e))},W.escapeFragment=function(e){return encodeURIComponent(n(e))},W.escapeJsonPointer=n,W.unescapeJsonPointer=o,W.eachItem=function(e,t){if(Array.isArray(e))for(const r of e)t(r);else t(e)},W.mergeEvaluated={props:i({mergeNames:(t,r,s)=>t.if(e._`${s} !== true && ${r} !== undefined`,(()=>{t.if(e._`${r} === true`,(()=>t.assign(s,!0)),(()=>t.assign(s,e._`${s} || {}`).code(e._`Object.assign(${s}, ${r})`)))})),mergeToName:(t,r,s)=>t.if(e._`${s} !== true`,(()=>{!0===r?t.assign(s,!0):(t.assign(s,e._`${s} || {}`),c(t,s,r))})),mergeValues:(e,t)=>!0===e||{...e,...t},resultToName:a}),items:i({mergeNames:(t,r,s)=>t.if(e._`${s} !== true && ${r} !== undefined`,(()=>t.assign(s,e._`${r} === true ? true : ${s} > ${r} ? ${s} : ${r}`))),mergeToName:(t,r,s)=>t.if(e._`${s} !== true`,(()=>t.assign(s,!0===r||e._`${s} > ${r} ? ${s} : ${r}`))),mergeValues:(e,t)=>!0===e||Math.max(e,t),resultToName:(e,t)=>e.var("items",t)})},W.evaluatedPropsToName=a,W.setEvaluated=c;const l={};var u;function d(e,t,r=e.opts.strictSchema){if(r){if(t=`strict mode: ${t}`,!0===r)throw new Error(t);e.self.logger.warn(t)}}return W.useFunc=function(e,r){return e.scopeValue("func",{ref:r,code:l[r.code]||(l[r.code]=new t._Code(r.code))})},function(e){e[e.Num=0]="Num",e[e.Str=1]="Str"}(u||(W.Type=u={})),W.getErrorPath=function(t,r,s){if(t instanceof e.Name){const n=r===u.Num;return s?n?e._`"[" + ${t} + "]"`:e._`"['" + ${t} + "']"`:n?e._`"/" + ${t}`:e._`"/" + ${t}.replace(/~/g, "~0").replace(/\\//g, "~1")`}return s?(0,e.getProperty)(t).toString():"/"+n(t)},W.checkStrictMode=d,W}var Q,X,Y,ee={};function te(){if(Q)return ee;Q=1,Object.defineProperty(ee,"__esModule",{value:!0});const e=J(),t={data:new e.Name("data"),valCxt:new e.Name("valCxt"),instancePath:new e.Name("instancePath"),parentData:new e.Name("parentData"),parentDataProperty:new e.Name("parentDataProperty"),rootData:new e.Name("rootData"),dynamicAnchors:new e.Name("dynamicAnchors"),vErrors:new e.Name("vErrors"),errors:new e.Name("errors"),this:new e.Name("this"),self:new e.Name("self"),scope:new e.Name("scope"),json:new e.Name("json"),jsonPos:new e.Name("jsonPos"),jsonLen:new e.Name("jsonLen"),jsonPart:new e.Name("jsonPart")};return ee.default=t,ee}function re(){return X||(X=1,function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.extendErrors=e.resetErrorsCount=e.reportExtraError=e.reportError=e.keyword$DataError=e.keywordError=void 0;const t=J(),r=Z(),s=te();function n(e,r){const n=e.const("err",r);e.if(t._`${s.default.vErrors} === null`,(()=>e.assign(s.default.vErrors,t._`[${n}]`)),t._`${s.default.vErrors}.push(${n})`),e.code(t._`${s.default.errors}++`)}function o(e,r){const{gen:s,validateName:n,schemaEnv:o}=e;o.$async?s.throw(t._`new ${e.ValidationError}(${r})`):(s.assign(t._`${n}.errors`,r),s.return(!1))}e.keywordError={message:({keyword:e})=>t.str`must pass "${e}" keyword validation`},e.keyword$DataError={message:({keyword:e,schemaType:r})=>r?t.str`"${e}" keyword must be ${r} ($data)`:t.str`"${e}" keyword is invalid ($data)`},e.reportError=function(r,s=e.keywordError,i,c){const{it:l}=r,{gen:u,compositeRule:d,allErrors:p}=l,f=a(r,s,i);(null!=c?c:d||p)?n(u,f):o(l,t._`[${f}]`)},e.reportExtraError=function(t,r=e.keywordError,i){const{it:c}=t,{gen:l,compositeRule:u,allErrors:d}=c;n(l,a(t,r,i)),u||d||o(c,s.default.vErrors)},e.resetErrorsCount=function(e,r){e.assign(s.default.errors,r),e.if(t._`${s.default.vErrors} !== null`,(()=>e.if(r,(()=>e.assign(t._`${s.default.vErrors}.length`,r)),(()=>e.assign(s.default.vErrors,null)))))},e.extendErrors=function({gen:e,keyword:r,schemaValue:n,data:o,errsCount:i,it:a}){if(void 0===i)throw new Error("ajv implementation error");const c=e.name("err");e.forRange("i",i,s.default.errors,(i=>{e.const(c,t._`${s.default.vErrors}[${i}]`),e.if(t._`${c}.instancePath === undefined`,(()=>e.assign(t._`${c}.instancePath`,(0,t.strConcat)(s.default.instancePath,a.errorPath)))),e.assign(t._`${c}.schemaPath`,t.str`${a.errSchemaPath}/${r}`),a.opts.verbose&&(e.assign(t._`${c}.schema`,n),e.assign(t._`${c}.data`,o))}))};const i={keyword:new t.Name("keyword"),schemaPath:new t.Name("schemaPath"),params:new t.Name("params"),propertyName:new t.Name("propertyName"),message:new t.Name("message"),schema:new t.Name("schema"),parentSchema:new t.Name("parentSchema")};function a(e,r,n){const{createErrors:o}=e.it;return!1===o?t._`{}`:function(e,r,n={}){const{gen:o,it:a}=e,u=[c(a,n),l(e,n)];return function(e,{params:r,message:n},o){const{keyword:a,data:c,schemaValue:l,it:u}=e,{opts:d,propertyName:p,topSchemaRef:f,schemaPath:m}=u;o.push([i.keyword,a],[i.params,"function"==typeof r?r(e):r||t._`{}`]),d.messages&&o.push([i.message,"function"==typeof n?n(e):n]);d.verbose&&o.push([i.schema,l],[i.parentSchema,t._`${f}${m}`],[s.default.data,c]);p&&o.push([i.propertyName,p])}(e,r,u),o.object(...u)}(e,r,n)}function c({errorPath:e},{instancePath:n}){const o=n?t.str`${e}${(0,r.getErrorPath)(n,r.Type.Str)}`:e;return[s.default.instancePath,(0,t.strConcat)(s.default.instancePath,o)]}function l({keyword:e,it:{errSchemaPath:s}},{schemaPath:n,parentSchema:o}){let a=o?s:t.str`${s}/${e}`;return n&&(a=t.str`${a}${(0,r.getErrorPath)(n,r.Type.Str)}`),[i.schemaPath,a]}}(q)),q}var se,ne={},oe={};function ie(){if(se)return oe;se=1,Object.defineProperty(oe,"__esModule",{value:!0}),oe.getRules=oe.isJSONType=void 0;const e=new Set(["string","number","integer","boolean","null","object","array"]);return oe.isJSONType=function(t){return"string"==typeof t&&e.has(t)},oe.getRules=function(){const e={number:{type:"number",rules:[]},string:{type:"string",rules:[]},array:{type:"array",rules:[]},object:{type:"object",rules:[]}};return{types:{...e,integer:!0,boolean:!0,null:!0},rules:[{rules:[]},e.number,e.string,e.array,e.object],post:{rules:[]},all:{},keywords:{}}},oe}var ae,ce,le={};function ue(){if(ae)return le;function e(e,r){return r.rules.some((r=>t(e,r)))}function t(e,t){var r;return void 0!==e[t.keyword]||(null===(r=t.definition.implements)||void 0===r?void 0:r.some((t=>void 0!==e[t])))}return ae=1,Object.defineProperty(le,"__esModule",{value:!0}),le.shouldUseRule=le.shouldUseGroup=le.schemaHasRulesForType=void 0,le.schemaHasRulesForType=function({schema:t,self:r},s){const n=r.RULES.types[s];return n&&!0!==n&&e(t,n)},le.shouldUseGroup=e,le.shouldUseRule=t,le}function de(){if(ce)return ne;ce=1,Object.defineProperty(ne,"__esModule",{value:!0}),ne.reportTypeError=ne.checkDataTypes=ne.checkDataType=ne.coerceAndCheckDataType=ne.getJSONTypes=ne.getSchemaTypes=ne.DataType=void 0;const e=ie(),t=ue(),r=re(),s=J(),n=Z();var o;function i(t){const r=Array.isArray(t)?t:t?[t]:[];if(r.every(e.isJSONType))return r;throw new Error("type must be JSONType or JSONType[]: "+r.join(","))}!function(e){e[e.Correct=0]="Correct",e[e.Wrong=1]="Wrong"}(o||(ne.DataType=o={})),ne.getSchemaTypes=function(e){const t=i(e.type);if(t.includes("null")){if(!1===e.nullable)throw new Error("type: null contradicts nullable: false")}else{if(!t.length&&void 0!==e.nullable)throw new Error('"nullable" cannot be used without "type"');!0===e.nullable&&t.push("null")}return t},ne.getJSONTypes=i,ne.coerceAndCheckDataType=function(e,r){const{gen:n,data:i,opts:c}=e,u=function(e,t){return t?e.filter((e=>a.has(e)||"array"===t&&"array"===e)):[]}(r,c.coerceTypes),p=r.length>0&&!(0===u.length&&1===r.length&&(0,t.schemaHasRulesForType)(e,r[0]));if(p){const t=l(r,i,c.strictNumbers,o.Wrong);n.if(t,(()=>{u.length?function(e,t,r){const{gen:n,data:o,opts:i}=e,c=n.let("dataType",s._`typeof ${o}`),u=n.let("coerced",s._`undefined`);"array"===i.coerceTypes&&n.if(s._`${c} == 'object' && Array.isArray(${o}) && ${o}.length == 1`,(()=>n.assign(o,s._`${o}[0]`).assign(c,s._`typeof ${o}`).if(l(t,o,i.strictNumbers),(()=>n.assign(u,o)))));n.if(s._`${u} !== undefined`);for(const e of r)(a.has(e)||"array"===e&&"array"===i.coerceTypes)&&p(e);function p(e){switch(e){case"string":return void n.elseIf(s._`${c} == "number" || ${c} == "boolean"`).assign(u,s._`"" + ${o}`).elseIf(s._`${o} === null`).assign(u,s._`""`);case"number":return void n.elseIf(s._`${c} == "boolean" || ${o} === null
