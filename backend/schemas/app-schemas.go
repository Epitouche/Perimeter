...
// Errors Messages.
var (
	ErrBackendPortNotSet = errors.New(
		"BACKEND_PORT is not set",
	) // Error message for missing BACKEND_PORT environment variable
	ErrFrontendPortNotSet = errors.New(
		"FRONTEND_PORT is not set",
	) // Error message for missing FRONTEND_PORT environment variable
	ErrFrontendExternalHostNotSet = errors.New(
		"FRONTEND_EXTERNAL_HOST is not set",
	) // Error message for missing FRONTEND_EXTERNAL_HOST environment variable
	ErrIsProductionNotSet = errors.New(
		"IS_PRODUCTION is not set",
	) // Error message for missing IS_PRODUCTION environment variable
	ErrMissingAuthenticationCode = errors.New(
		"missing authentication code",
	) // Error message for missing authentication code
	ErrCreateRequest = errors.New(
		"error create request",
	) // Error message for failed request creation
	ErrDoRequest = errors.New(
		"error do request",
	) // Error message for failed request execution
	ErrDecode = errors.New(
		"error decode",
	) // Error message for failed decoding
	...
	ErrHashingPassword = errors.New(
		"error hashing the password",
	) // Error message for hashing password
	ErrMissingCode = errors.New(
		"missing code",
	) // Error message for missing code
	ErrMissingCodeVerifier = errors.New(
		"missing code verifier",
	) // Error message for missing code verifier
)
