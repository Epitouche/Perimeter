...
:ui="{
      ...
      <div class="flex flex-col items-center gap-14 overflow-y-scroll max-h-[60vh]">
...
v-model="password" type="password" :ui="{
        ...
        <div class="flex flex-col justify-center gap-1 items-center min-w-full py-5">
          <div v-if="loginError" class="text-red-500 text-xl pb-1">
            {{ loginError }}
          </div>
          <UButton class="text-center px-10 py-7 max-lg:py-5 max-sm:py-3" tabindex="0" @click="handleLogin">
            <h5>Log in</h5>
          </UButton>
          <p>
            New?
