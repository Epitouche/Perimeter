...
<template>
  <div class="flex flex-col justify-center items-center gap-10 w-full">
    ...
    <div v-else class="flex flex-col justify-center items-start gap-10 w-[90%] h-full p-10 rounded-custom_border_radius bg-custom_color-bg_section" >

      <div class="flex flex-row justify-between items-center w-full px-5 pt-1">
        <SearchBar v-model:search-query="searchQuery" />
      </div>
    
      <UContainer class="flex flex-wrap gap-5 justify-center p-4 bg-white rounded-lg w-full mx-auto" >
