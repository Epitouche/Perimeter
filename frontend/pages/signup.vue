...
<template>
  <div class="flex justify-center items-center w-full h-screen">
    ...
    }" class="bg-custom_color-bg_section flex flex-col justify-between items-center gap-10 px-10 py-12 rounded-custom_border_radius">
      <h1 class="pb-4">Sign up</h1>
      <div class="flex flex-col gap-10 min-w-[80%] max-w-[80%] px-5">
        <div class="flex flex-col gap-10 w-full overflow-y-scroll pr-10 max-h-[24vh]">
