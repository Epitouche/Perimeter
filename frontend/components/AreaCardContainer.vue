...
const getQueryParam = (param: LocationQueryValue | LocationQueryValue[] | undefined): string | null => {
...
const updateAreaValue = async (areaId: number, typeName: string, keyString: string, value: string | number) => {
  console.log("areaId:", areaId, "typeName:", typeName, "keyString:", keyString, "value:", value);
  ...
  if (typeName === "action") {
    ...
    (updatedArea.action_option as { [key: string]: string | number })[keyString] =
      typeof value === "string" && !isNaN(Number(value))
        ? Number(value)
        : value;
    (updatedArea.action.option as { [key: string]: string | number })[keyString] =
      typeof value === "string" && !isNaN(Number(value))
        ? Number(value)
        : value;
    ...
    (updatedArea.reaction_option as { [key: string]: string | number })[keyString] =
      typeof value === "string" && !isNaN(Number(value))
        ? Number(value)
        : value;
    (updatedArea.reaction.option as { [key: string]: string | number })[keyString] =
      typeof value === "string" && !isNaN(Number(value))
        ? Number(value)
        : value;
